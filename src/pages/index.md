---
permalink: /
title: getzeropoint.com Website Starter
...
<header>
  <figure class="logo">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 486.1 146.7" xml:space="preserve">
      <linearGradient id="getzeropoint.comGradient">
  ...
  <h1 class="visually-hidden">getzeropoint.com</h1>
  <p class="lead">Start your website project from zero</p>
</header>

<section class="get-started">
  <a class="button button-get-started" href="https://github.com/MWDelaney/getzeropoint.com/generate">
    Launch
  </a>
</section>

<section class="what">
  <h2>What is <em>getzeropoint.com</em>?</h2>
  <hr>
  <p>
  ...
  <p><em>getzeropoint.com</em> is a free, new-user oriented website starter designed to walk you through creating, editing, and publishing a personal, professional, just fun website all on your own.</p>
</section>

<section class="what-really">
  <h2>Okay but what is <em>getzeropoint.com</em> really?</h2>
  <hr>
  <p>
    <em>getzeropoint.com</em> is a static site generator built using <a href="https://eleventy.dev">Eleventy</a> and designed to smooth the process of using <a href="https://github.com">GitHub</a> and <a href="http://netlify.com">Netlify<a> to edit and launch websites of all sizes.
  </p>
</section>
